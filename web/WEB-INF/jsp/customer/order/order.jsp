...
<div>
    ...
    <%--    确认生成订单  --%>
    <table class="table table-striped table-bordered buy-table">
        <tr>
            <th>图书封面</th>
            <th>书名</th>
            <th>原价</th>
        ...
        <c:forEach items="${cart.bookItems }" var="item" varStatus="s">
            <tr>
                <td><a href="book/info?id=${item.book.id}"><img src="${item.book.coverUrl}" height="50px" alt="图书封面"></a></td>
    ...
    <form action="order/submit" method="post">
        ...
        <button class="btn btn-primary"><a href="book/list">取消下单 继续购物</a></button>
    </form>
