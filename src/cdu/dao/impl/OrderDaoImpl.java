...
import cdu.dao.BookDao;
import cdu.dao.CustomerDao;
import cdu.dao.OrderDao;
import cdu.model.BookItem;
...
public class OrderDaoImpl extends BaseDao implements OrderDao {
    ...
    public int insert(Order order) {
        int rows = 0;
        String sql = "INSERT INTO order_table(orderId,customerId,books,money,status,createTime,receiverName,receiverTel,receiverAddress) VALUES(?,?,?,?,?,?,?,?,?) ";
        try {
            pstmt = conn.prepareStatement(sql);
